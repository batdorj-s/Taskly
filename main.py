...
# Хөтөч аюулгүй байдлын үүднээс өөр домэйноос (localhost:3000) ирэх хүсэлтийг блок хийдэг.
# Үүнийг CORS (Cross-Origin Resource Sharing) гэж нэрлэдэг.
# Бид frontend-ээсээ backend рүү хандахын тулд дараах тохиргоог заавал нэмэх ёстой.
origins = [
    "http://localhost:3000",
    "http://127.0.0.1:3000",
]
...
app.add_middleware(
    ...
    allow_methods=["*"], # Бүх төрлийн хүсэлтийг (GET, POST, PUT, DELETE) зөвшөөрөх
    allow_headers=["*"], # Бүх төрлийн Header-ийг зөвшөөрөх
)
